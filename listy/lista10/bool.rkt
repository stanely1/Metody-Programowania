...
;; byc moze warto pozbyc sie wyrazenia cond z jezyka
;; a wyrazenia (cond ...) parsowac od razu jako (if x (if ...))
...
(define (eval [e : Exp]) : Value
  (type-case Exp e
    ...
    #;[(condE cs)
     (eval (cond->if cs))]
    [else (error 'eval "desugaration error")]))

(define (run [e : S-Exp]) : Value
  (eval (desugarate (parse e))))  ;; zmiana - dodajemy odcukrzanie
